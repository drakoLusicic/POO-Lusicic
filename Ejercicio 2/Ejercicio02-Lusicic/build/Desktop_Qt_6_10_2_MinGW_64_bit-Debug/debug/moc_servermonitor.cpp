...
void ServerMonitor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ServerMonitor::*)(const ServerMetrics & )>(_a, &ServerMonitor::metricsUpdated, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ServerMonitor::*)(const QString & )>(_a, &ServerMonitor::errorOccurred, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (ServerMonitor::*)(const QString & )>(_a, &ServerMonitor::eventLogged, 2))
            return;
    }
}
...
// SIGNAL 1
void ServerMonitor::errorOccurred(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void ServerMonitor::eventLogged(const QString & _t1)
{
